...
# import pandas as pd
# from patriot_league_match_reports import bucknell_match_reports
#
#
#
...
#         return None, None
#
# def save_match_data_to_excel(metadata: dict, stats: dict, filename="match_data2023.xlsx"):
#     """
#     Saves the match metadata and statistics to an Excel file.
#     Ensures that the first three columns are 'Home', 'Away', and 'Date'.
#     Appends a new row each time the function is called.
#     """
...
#
#     # Check if the file exists and whether the sheet exists
#     if os.path.exists(filename):
#         with pd.ExcelWriter(filename, mode='a', engine='openpyxl', if_sheet_exists='overlay') as writer:
#             df.to_excel(writer, index=False, sheet_name="Match Stats", header=False)
#     else:
...
#
#     print(f"Match data successfully saved to {filename}!")
#
#
#
#
...
#     extracted_text = extract_text_from_pdf("2023.pdf")
#
...
#     print(f"Attendance: {metadata['attendance']}")
#     print(f"Stadium: {metadata['stadium']}")
#     print(f"Referee: {metadata['referee']}")
#
#     print("Match Statistics:")
#     print(f"Shots by American (Home): {shots_home}")
#     print(f"Shots by Bucknell (Away): {shots_away}")
#     print(f"Goals by American (Home): {goals_home}")
#     print(f"Goals by Bucknell (Away): {goals_away}")
#     print(f"Saves by American (Home): {saves_home}")
#     print(f"Saves by Bucknell (Away): {saves_away}")
#     print(f"Fouls by American (Home): {fouls_home}")
#     print(f"Fouls by Bucknell (Away): {fouls_away}")
#     print(f"Corner Kicks by American (Home): {corners_home}")
#     print(f"Corner Kicks by Bucknell (Away): {corners_away}")
#
